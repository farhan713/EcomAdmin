...
export class ReviewsComponent implements OnInit {
  ...
  public getTopSearchResult() {
    // this.http.get<any>('http://127.0.0.1:8000/console/'+this.clickService.getAdminOrgId()+'/top_search_queries/' + this.selectedDay).subscribe({
    //   next: data => {
    //     this.topSearchResult = data.dataset;
    //     console.log(this.topSearchResult,"aniket code here");


    //   }
    // });
    this.auth.sendHttpGet('http://127.0.0.1:8000/console/' + this.clickService.getAdminOrgId() + '/top_search_queries/' + this.selectedDay)
      .then((respData) => {
        this.topSearchResult = respData.datalist;
